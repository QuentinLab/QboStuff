...
class NavTest():
	...
	locations = dict()
        locations['p1'] = Pose(Point(1.404, 2.869, 0.000), Quaternion(0.000, 0.000, -0.806, 0.592))
        locations['p2'] = Pose(Point(1.200,-1.372, 0.000), Quaternion(0.000, 0.000, 0.242, 0.970))
        locations['p3'] = Pose(Point(5.130, -0.883, 0.000), Quaternion(0.000, 0.000, 0.673, 0.740))
        locations['p4'] = Pose(Point(3.853,3.572, 0.000), Quaternion(0.000, 0.000, 0.999, 0.041))
