...
void FaceDetector::setROSParams()
{
	...
	string default_classifier_path = "/home/qbobot/Documents/cascades/haarcascade_frontalface_alt2.xml";
...
void FaceDetector::onInit()
{
	 ...
	 */
	info_sub_=private_nh_.subscribe<sensor_msgs::CameraInfo>("/camera/rgb/camera_info",10,&FaceDetector::infoCallback, this);
...
//p_ is the projection camera matrix
	...
	if(allZeros){
		 ...
		 */
        image_sub_=private_nh_.subscribe<sensor_msgs::Image>("/camera/rgb/image_raw",1,&FaceDetector::imageCallback, this);
